...
keymap -c .keymap.config.corne.yaml parse -z config/cradio.keymap > keymap.ferris-sweep.yaml
keymap -c .keymap.config.corne.yaml parse -z config/corne.keymap > keymap.corne.yaml
